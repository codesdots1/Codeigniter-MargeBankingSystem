                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <!-- Start Site -->
                            <li>
                                <a href="#"><i class="fa fa-gears"></i> <span><?= lang('settings') ?></span></a>
                                <ul>
                                    <?php
                                    //Country
                                    if ($CI->dt_ci_acl->checkAccess("Country|index")) {
                                        echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Country/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Country") . '><a  href="' . base_url() . 'Country"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('country') . '</span></a></li>';
                                    }
                                    ?>

                                    <?php
                                    //State
                                    if ($CI->dt_ci_acl->checkAccess("State|index")) {
                                        echo '<li ' . $CI->dt_ci_acl->getActiveMenu("State/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("State") . '><a  href="' . base_url() . 'State"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('state') . '</span></a></li>';
                                    }
                                    ?>

                                    <?php
                                    //City
                                    if ($CI->dt_ci_acl->checkAccess("City|index")) {
                                        echo '<li ' . $CI->dt_ci_acl->getActiveMenu("City/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("City") . '><a  href="' . base_url() . 'City"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('city') . '</span></a></li>';
                                    }
                                    ?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Branch|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Branch/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Branch") . '><a  href="' . base_url() . 'Branch"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('branch') . '</span></a></li>';
										}
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Religion|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Religion/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Religion") . '><a  href="' . base_url() . 'Religion"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('religion') . '</span></a></li>';
										}
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Occupation|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Occupation/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Occupation") . '><a  href="' . base_url() . 'Occupation"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('occupation') . '</span></a></li>';
										}
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Caste|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Caste/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Caste") . '><a  href="' . base_url() . 'Caste"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('caste') . '</span></a></li>';
										}
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("BloodGroup|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("BloodGroup/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("BloodGroup") . '><a  href="' . base_url() . 'BloodGroup"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('bloodGroup') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Education|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Education/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Education") . '><a  href="' . base_url() . 'Education"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('education') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Gender|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Gender/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Gender") . '><a  href="' . base_url() . 'Gender"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('gender') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("MaritalStatus|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("MaritalStatus/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("MaritalStatus") . '><a  href="' . base_url() . 'MaritalStatus"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('marital_status') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Section|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Section/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Section") . '><a  href="' . base_url() . 'Section"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('section') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Scheme|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Scheme/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Scheme") . '><a  href="' . base_url() . 'Scheme"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('scheme') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("CostCenter|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("CostCenter/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("CostCenter") . '><a  href="' . base_url() . 'CostCenter"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('cost_center') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Amsom|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Amsom/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Amsom") . '><a  href="' . base_url() . 'Amsom"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('amsom') . '</span></a></li>';
									    }
									?>

									<?php
										if ($CI->dt_ci_acl->checkAccess("Desom|index")) {
											echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Desom/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Desom") . '><a  href="' . base_url() . 'Desom"><i class="fa fa-list"></i><span class="sidebar-mini-hide">' . lang('desom') . '</span></a></li>';
									    }
									?>
                            ...
                            <!-- Customer-->
                            <li>
                                <a href="#"><i class="fa fa-user"></i> <span><?= lang('customer') ?></span></a>
                                <ul>
									<?php
									//Customer
									if ($CI->dt_ci_acl->checkAccess("Customer|index")) {
										echo '<li ' . $CI->dt_ci_acl->getActiveMenu("Customer/index") . ' ' . $CI->dt_ci_acl->getActiveMenu("Customer") . '><a  href="' . base_url() . 'Customer"><i class="fa fa-user"></i><span class="sidebar-mini-hide">' . lang('customer') . '</span></a></li>';
									}
									?>
                                </ul>
                            </li>
                            ...
                            <!-- Reports-->
                            <li>
                                <a href="#"><i class="fa fa-bar-chart"></i> <span><?= lang('reports') ?></span></a>
                                <ul>
                                </ul>
                            </li>
                            <!-- End Reports-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div class="footer text-muted">
                    &copy; <?php echo date('Y'); ?> <a href="http://digitattva.in/?ref=tre" target="_blank">Marg Techo</a>
                </div>
                <!-- /footer -->
