...
defined('SITE_NAME') OR define('SITE_NAME', 'MARG TECH');


//Message Constants
defined('GENDER') OR define('GENDER', 'Gender');
defined('OCCUPATION') OR define('OCCUPATION', 'Occupation');
...
defined('MARGTECH') OR define('MARGTECH', 'Marg Tech');
...
defined('IMAGE_DIR_URL')         OR define('IMAGE_DIR_URL', 'http://192.168.0.128/samaj/');
defined('AUDIO_DIR_URL')         OR define('AUDIO_DIR_URL', 'http://localhost:7777/samaj/');
